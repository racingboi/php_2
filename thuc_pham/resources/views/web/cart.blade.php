            ...
            <div class="col-main">
                <div class="cart wow bounceInUp animated">
                        ...
                        <form method="post" action="#updatePost/">
                            ...
                            <fieldset>
                                <table class="data-table cart-table" id="shopping-cart-table">
                                    ...
                                    <tfoot>
                                        <tr class="first last">
                                            <td class="a-right last" colspan="50"><button onclick="setLocation('#')"
                                                    class="button btn-continue" title="Continue Shopping"
                                                    type="button"><span><span>Continue Shopping</span></span></button>
                                                <button class="button btn-update" title="Update Cart" value="update_qty"
                                                    name="update_cart_action" type="submit"><span><span>Update
                                                ...
                                                <button id="empty_cart_button" class="button btn-empty" title="Clear Cart"
                                                    ...
                                                    type="submit"><span><span>Clear Cart</span></span></button>
                                            </td>
                                        </tr>
                                    </tfoot>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <h2 class="product-name "> <a href="#/women-s-crepe-printed-black/">Sample
                                                        Product</a> </h2>
                                            </td>
                                            <td class="a-center"><a title="Edit item parameters" class="edit-bnt"
                                                    href="#configure/id/15945/"></a></td>
                                            <td class="a-right"><span class="cart-price"> <span class="price">$70.00</span>
                                                </span></td>
                                            <td class="a-center movewishlist"><input maxlength="12" class="input-text qty"
                                                    title="Qty" size="4" value="1" name="cart[15945][qty]">
                                            </td>
                                            <td>a</td>
                                            <td class="a-right movewishlist"><span class="cart-price"> <span
                                                        class="price">$70.00</span> </span></td>
                    ...
                    <div class="cart-collaterals row">
                        <div class="col-sm-4">
                            <div class="shipping">
                                <h3><span>Estimate Shipping and Tax</span></h3>
                                    ...
                                    <form id="shipping-zip-form" method="post" action="#estimatePost/">
                                        ...
                                        <ul class="form-list">
                                            ...
                                            <li>
                                                ...
                                                <div class="input-box">
                                                    <select style="" title="State/Province" name="region_id"
                                        ...
                                        <div class="buttons-set11">
                                            <button class="button get-quote" onclick="coShippingMethodForm.submit()"
                                                title="Get a Quote" type="button"><span>Get a Quote</span></button>
                                        </div>
                                        <!--buttons-set11-->
                                    </form>
                                </div>
                        ...
                        <div class="col-sm-4">
                            <div class="discount">
                                <form method="post"
                                    action="http://newsmartwave.net/magento/kallyas/index.php/checkout/cart/couponPost/">

                                    <h3><span>Discount Codes</span></h3>
                                </form>
                                <form method="post" action="#couponPost/">
                                    ...
                                    <button value="Apply Coupon" onclick="discountForm.submit(false)"
                                        class="button coupon " title="Apply Coupon" type="button"><span>Apply
                                            Coupon</span></button>
                        ...
                        <div class="totals col-sm-4">
                            <h3><span>Shopping Cart Total</span></h3>
                            <div class="inner">
                                ...
                                <ul class="checkout">
                                    <li>
                                        <button
                                            onclick="window.location='http://demo.magikthemes.com/index.php/Micrablue/checkout/onepage/';"
                                    ...
                                    <li><a title="Checkout with Multiple Addresses"
                                            href="multiple_addresses.html">Checkout with Multiple Addresses</a> </li>
                                    <br>
                                </ul>
                            </div>
                            <!--inner-->
                                ...
                                <div class="item-inner">
                                    <div class="product-block">
                                        ...
                                        <div class="product-meta">
                                            <div class="product-action"> <a class="addcart" href="shopping_cart.html">
